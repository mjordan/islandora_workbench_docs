...
| use_node_title_for_media_title | | true | If set to `true` (default), name media the same as the parent node's title value. If `false`, the filename of the media will be used as the media name. |
