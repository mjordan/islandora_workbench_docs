...
| drupal_8 |  | false | Tells Workbench that it is communicating with a Drupal version lower than 8.6. Intended to be used in integration tests only. Users should never need to use this setting. |
