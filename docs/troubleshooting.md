...
The `#islandoraworkbench` Slack channel is the best place to ask a question if Workbench isn't working the way you expect or if it crashes. To access this channel, visit [islandora.slack.com](https://islandora.slack.com). You can also [open a Github issue](https://github.com/mjordan/islandora_workbench/issues).
