...
!!! note
    ...
    This has been resolved in Drupal version [10.1.0](https://www.drupal.org/project/drupal/issues/2949017) and higher. Those versions allow users who don't own a file to delete it.
