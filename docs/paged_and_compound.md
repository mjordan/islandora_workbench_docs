...
# In this type of task, CSV field templates apply to the children being created,
# not the existing parent.
csv_field_templates:
- field_language: Italian

page_title_template: '$parent_title, side $weight'

# In this type of task, either csv_field_templates or csv_value_templates_for_paged_content
# can be used to apply optional field values to children being created.
