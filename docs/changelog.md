...
* February 4, 2026: Create a new changelog for 2026; updated note on "[Deleting media](/islandora_workbench_docs/deleting_media/)" about not being able to delete files not created by the current user; merged first draft of [running Workbench in a venv](/islandora_workbench_docs/installation_with_venv/). Thanks @ysuarez!
